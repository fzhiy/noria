...
NORIA is a provenance-tracked academic knowledge base for PhD research on "continual adaptation of web agents under UI/workflow drifts". The researcher evaluated expanding information sources beyond Semantic Scholar, arXiv, and Zotero to include GitHub, Reddit, Twitter/X, WeChat公众号, and 小红书.
