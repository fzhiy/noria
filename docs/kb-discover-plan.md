...
NORIA has claim-level citations and Open Questions but lacks**跨论文 insight 发现**能力。Session 7 handoff 明确要求实现此功能作为 P0。
...
2. BFS shortest paths between all concept pairs (instant for typical wiki sizes)
